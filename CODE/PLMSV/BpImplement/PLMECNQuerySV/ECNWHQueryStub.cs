...
namespace UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV
{
    ...
    public class ECNWHQueryStub : ServiceStubBase, IECNWHQuery
    {
        #region IECNWHQuery Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String bOMItemInfo, System.String contextInfo)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.ECNWHQuery");                
                ECNWHQuery objectRef = new ECNWHQuery();
            ...
            {
				FinallyInvoke("UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.ECNWHQuery");
            }
        }
	#endregion
    }
