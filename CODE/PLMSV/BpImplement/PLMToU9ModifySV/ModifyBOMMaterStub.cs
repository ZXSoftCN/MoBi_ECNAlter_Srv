...
namespace UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV
{
    ...
    public class ModifyBOMMaterStub : ServiceStubBase, IModifyBOMMater
    {
        #region IModifyBOMMater Members
        ...
        public System.String DoEx(ICommonDataContract commonData, System.String pLMECNInfo, System.String contextInfo)
        {
            ...
            try
            {
                BeforeInvoke("UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.ModifyBOMMater");                
                ModifyBOMMater objectRef = new ModifyBOMMater();
            ...
            {
				FinallyInvoke("UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.ModifyBOMMater");
            }
        }
	#endregion
    }
