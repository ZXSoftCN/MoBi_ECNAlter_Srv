...
namespace UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.Proxy
{
	...
	[Serializable]    
    public class ECNMOQueryProxy : ServiceProxyBase//, UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.Proxy.IECNMOQuery
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeBySite<UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.Proxy.IECNMOQuery>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeByOrg<UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.Proxy.IECNMOQuery>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.Safor.VW.PLMSV.PLMECNQuerySV.Proxy.IECNMOQuery>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IECNMOQuery channel = oChannel as IECNMOQuery;
            if (channel != null)
            {
