...
namespace UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.Proxy
{
	...
	[Serializable]    
    public class ModifyMOPickListProxy : ServiceProxyBase//, UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.Proxy.IModifyMOPickList
    {
	#region Fields	
	...
	#region Constructors
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeBySite<UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.Proxy.IModifyMOPickList>(targetSite);
        ...
        {
  			InitKeyList() ;
			System.String result = (System.String)InvokeByOrg<UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.Proxy.IModifyMOPickList>(targetOrgId);
			return GetRealResult(result);
        }
		#endregion end跨组织调用
        ...
        {
  			InitKeyList() ;
 			System.String result = (System.String)InvokeAgent<UFIDA.U9.Safor.VW.PLMSV.PLMToU9ModifySV.Proxy.IModifyMOPickList>();
			return GetRealResult(result);
        }
		...
		protected override object InvokeImplement<T>(T oChannel)
        {
            ...
            IModifyMOPickList channel = oChannel as IModifyMOPickList;
            if (channel != null)
            {
